function[WW]=frame_WWalgorithmRight(w,L,nodes,conn,angle,sup1,sup2,J,M,E,G,k,I,Ip,A,Rho,Mu,Lcr11,Lcr22,Lcr33,Mcr11,Mcr22,Mcr33)
%Code to be stored in a file named 'WWalgorithmRight.m'. 'Right' represents that the spring-mass system is roving on the Right segment of the cracked beam
...
DFGstiff(20,20)=DFGstiff(20,20)-M*w^2;
DFGstiff(21,21)=DFGstiff(21,21)-J*w^2;
%Assembling the global dynamic stiffness matrix of the whole system.
for i=1
	if bb(i)*rr(i)*ss(i)<1
